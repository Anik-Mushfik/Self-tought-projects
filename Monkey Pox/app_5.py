...
def main():
    ...
    st.video("https://www.youtube.com/watch?v=your_video_id")  # Replace with a valid video URL
    ...
    st.image("https://example.com/your_image.jpg", caption="Symptoms of Monkeypox", use_column_width=True)  # Replace with a valid image URL
